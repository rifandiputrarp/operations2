...
<div class="row">
            ...
            <div class="card-body">
                ...
                <input type="hidden" name="ver_produk_id" value="{{$verProduk[0]->id}}">
                  ...
                  <div class="form-group row">
                    ...
                    <label class="col-md-2">Merek</label>
                    <div class="col-md-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2">Jenis KBL</label>
                        <div class="col-md-9">
                            <select class="form-control"  id="jenis_kbl" name="jenis_kbl"  <?php if(count($files)>0){echo "disabled";}?> >
                                <option value="">-PILIH-</option>
                                @if(1 == $verProduk[0]->jenis_kbl)
                                    <option selected value="1">TKDN KBL R2 dan R3</option>
                                    <option value="2">TKDN KBL R4 atau Lebih</option>
                                @elseif(2 == $verProduk[0]->jenis_kbl)
                                    <option value="1">TKDN KBL R2 dan R3</option>
                                    <option selected value="2">TKDN KBL R4 atau Lebi</option>
                                @else
                                    <option value="1">TKDN KBL R2 dan R3</option>
                                    <option value="2">TKDN KBL R4 atau Lebih</option>
                                @endif
    ...
    <div class="col-12" id="file_perhitungan">
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <a href="{{ url('verifikasi/download/'.$permen_id.'/'.$verProduk[0]->jenis_kbl) }}" class="btn btn-sm btn-success text-left"><i class="fa fa-download"></i>&nbsp; Download Template</a>
                    </div>
                </div>
...
<script>
$(function () {
    <?php if($verProduk[0]->jenis_kbl==0){?>
    ...
    var table_upload = $('#table-upload').DataTable({
        ...
        "ajax": {
            ...
            "data": {'ver_produk_id':ver_produk_id}
        },
        "columns": [
            { "data": "no" },
            { "data": "nama_file" },
